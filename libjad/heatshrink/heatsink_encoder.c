...
HSE_sink_res heatshrink_encoder_sink(heatshrink_encoder *hse,
    ...
    uint16_t write_offset, ibs, rem, cp_sz;
...
#ifdef HEATSHRINK_DYNAMIC_ALLOC //zero 20-oct-2014 - this doesnt make sense unless we have HEATSHRINK_DYNAMIC_ALLOC and window_sz2 is available
